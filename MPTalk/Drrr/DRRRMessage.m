...
-(void)xmppStream:(XMPPStream *)sender didReceiveMessage:(XMPPMessage *)message{
    ...
    DRRRRosterMember *fromRoster=[[DRRRRoster alloc]memberByJid:content.fromJid];
    [[RecentMessageModal sharedManager]saveMeeage:content.body WithName:content.fromJid UnreadMessageTime:fromRoster.unread_total Time:content.time   isOutgoing:NO];
